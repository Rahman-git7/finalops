  ...
  return (
    <div className="p-8">
      ...
      <section className="mb-8">
        <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-4">Cette semaine</h3>
      ...
      <section className="mb-8">
        <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-4">Ce mois</h3>
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Séances récentes</h3>
        ...
        <div className="space-y-2">
          {recentSessions?.length === 0 && (
            <div className="bg-slate-900 border border-slate-800 rounded-xl p-8 text-center">
              <p className="text-slate-500 text-sm">Aucune séance enregistrée.</p>
          ...
          {recentSessions?.map(session => (
            <Link
              ...
              className="flex items-center justify-between bg-slate-900 border border-slate-800 hover:border-slate-700 rounded-xl px-5 py-4 transition-colors group"
            >
              <div>
